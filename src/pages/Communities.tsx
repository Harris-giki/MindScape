  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-blue-500 to-purple-600 py-16 px-4 rounded-lg mx-4 my-4 shadow-lg text-white relative overflow-hidden"
      >
        <div
        ...
        <div className="relative z-10">
          ...
          <p className="text-center text-white text-lg max-w-2xl mx-auto">
            Join local GIKI's MoodBoards to connect with students across campus,
            share thoughts, ideas and discuss life!
          </p>
        </div>
      </motion.div>
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="bg-white p-8 rounded-sm shadow-md max-w-md text-center">
                        <button
