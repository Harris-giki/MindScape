...
const Communities = () => {
  ...
  const { communities, addCommunity, joinCommunity, leaveCommunity } =
    useCommunityStore();
  ...
  const handleCreateCommunity = () => {
    if (!newCommunity.name || !newCommunity.area || !newCommunity.description) {
      toast({
        title: "Error",
        description:
          "Please fill in all required fields (Name, Area, Description).",
        variant: "destructive",
      });
      return;
    }
  ...
  return (
    <MainLayout>
      <SectionContainer>
        <SectionHeader
          title="Available MoodBoards"
          description="Join local GIKI's MoodBoards to connect with students across campus, share thoughts, ideas and discuss life!"
        />
        ...
        <div className="max-w-6xl mx-auto mb-10">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between mb-8">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Search MoodBoards by name, area, or description..."
                className="pl-10"
                value={searchQuery}
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Fill in the details to create a new MoodBoard
                  </DialogDescription>
                </DialogHeader>
              ...
              {joinedCommunities.length === 0 ? (
                <div className="text-center py-12 bg-blue-50 rounded-lg">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Join MoodBoards to connect with GIKIANs.
                  </p>
                  <Button
                    variant="outline"
                    ...
                    onClick={() => {
                      ...
                      const discoverTab = document.querySelector(
                        '[data-state="inactive"][data-value="discover"]'
                      ) as HTMLElement | null;
                      discoverTab?.click();
                    }}
                  >
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                Leaving this MoodBoard will remove you from its
                                member list and you will stop receiving
                                discussion notifications. You can rejoin
                                anytime.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
